        ...
        <div className='cards'>
            ...
            <div className="cards__container">
                ...
                <div className="cards__wrapper">
                    <ul className="cards__items">
                        <CardItem 
                        src='images/etienne-delorieux-ClmjVN1HZtE-unsplash.jpg'
                        text='La flora y fauna, volcanes, caminatas, senderos, parques nacionales.'
                        label='Bosques'
                        />
                        <CardItem 
                        src='images/zdenek-machacek-XUFMiGkv-60-unsplash.jpg'
