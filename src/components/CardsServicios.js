            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    <ul className="cards__items">
                        <CardItem 
                        src='images/philippe-dehaye-S2RoRghC6pM-unsplash.jpg'
                        text='Encuentre todas las opciones de hospedaje alrededor de todo el territorio costarricense.'
                        label='Hospedaje'
                        />
                        <CardItem 
                        src='images/josue-isai-ramos-figueroa-n2NBgIx3A28-unsplash.jpg'
